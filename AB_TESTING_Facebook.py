...
# İlk önce iki gruba da normallik testi uygulanmıştır. İki grubun da normal dağılıma uyduğu gözlemlendiğinden
...
# Satın alma anlamında anlamlı bbir fark olmadığından müşteri iki yöntemden birini seçebilir fakat burada diğer
